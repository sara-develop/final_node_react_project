...
const createSchedule = async (req, res) => {
    ...
    const existing = await WeeklySchedule.findOne({ classNumber })
    if (existing) {
        return res.status(409).json({ message: 'Schedule for this class already exists' })
    }
...
module.exports = { createSchedule, getSchedule, oneDaySchedule, updateSchedule, updateOneDaySchedule, deleteSchedule } 
